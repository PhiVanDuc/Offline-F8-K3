...
function Task({ task, column }) {
    ...
    return (
        ...
        >
            {
                !editMode ? 
                <p onClick={() => { setEditMode(!editMode) }}>{ content }</p> :
                <input type="text" className='input-edit-task-content' />     
            }

            <svg xmlns="http://www.w3.org/2000/svg" fill="none" style={styleButtonAdd} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 icon-delete" onClick={handleClickDeleteTask}>
